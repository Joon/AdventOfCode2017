...
describe("Puzzle1Calculator", () => {
    ...
    it("should calculate part 2 from sample on site", () => {
        let numberGrid = `5\t9\t2\t8
9\t4\t7\t3
3\t8\t6\t5`;

        let calc = new Puzzle2Calculator();
        expect(calc.CalcPart2(numberGrid)).toEqual("9");
    });

    it("should calculate part 1 from sample on site", () => {
        let numberGrid = `5\t1\t9\t5
7\t5\t3
2\t4\t6\t8`;

        let calc = new Puzzle2Calculator();
        expect(calc.CalcPart1(numberGrid)).toEqual("18");
    });

    it ("should calculate the puzzle result", () => {
...
1567	3246	4194	151	3112	903	1575	134	150	4184	3718	4077	180	4307	4097	1705`;
        ...
        let calc = new Puzzle2Calculator();
        expect(calc.CalcPart2(input)).toEqual("197");
    });
});